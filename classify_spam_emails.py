...
def handler(event, context):
    ...
    print(body)
    print(from_email)
    # train_url = 'https://runtime.sagemaker.us-east-1.amazonaws.com/endpoints/sms-spam-classifier-mxnet-2022-05-05-19-06-08-739/invocations'
    endpoint_name = 'sms-spam-classifier-mxnet-2022-05-05-19-06-08-739'
